...
public class MQConsumer extends IConnectToRabbitMQ {

    public MQConsumer(FactoryMQParam factoryMQParam) {
    ...
    public boolean connectToRabbitMQ()
    {
        if(super.connectToRabbitMQ())
        {
            ...
            if (factoryMQParam.getExchangeType() == "fanout")
    ...
    {
        try {
            mModel.queueBind(mQueue, factoryMQParam.getExchangeName(), routingKey);
        } catch (IOException e) {
    ...
    {
        try {
            mModel.queueUnbind(mQueue, factoryMQParam.getExchangeName(), routingKey);
        } catch (IOException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
